...
public class DragObject_8 : DragObject
{
    ...
    protected override void ExecuteFunction(){
        ...
        openSeq.Join(spriteRenderer.DOFade(0, openDuration).SetEase(Ease.InOutSine));
        Debug.Log("finished！"); 
    ...
    protected override void ObjectInclude(){
        ...
        Seq.Append(transform.DOScale(0.99f*originalScale, openDuration).SetEase(Ease.OutBack));
